...
- Si varias series quedan debajo del mínimo, sugerí reducir carga de forma conservadora.
- Si completa todas las series en el máximo del rango, con rendimiento estable, sugerí un aumento pequeño.
- Si está dentro del rango pero todavía no domina el máximo, mantené la carga.
